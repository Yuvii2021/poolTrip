...
export function packageResponse(pkg, user) {
...
export function bookingResponse(booking, pkg, passenger, host) {
    const transportation = pkg?.transportation ?? "";
    return {
...
export function sortByStatusThenDate(status, createdAt) {
